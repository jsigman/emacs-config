...
(defvar my-tempel-templates
  '(fundamental-mode ;; Available everywhere
    ...
    (py "#+begin_src ipython" n "  " r n "#+end_src")
    (elisp "#+begin_src emacs-lisp :load yes" n r n "#+end_src")

    ;; Enhanced src block with language selection
    (src "#+begin_src " (p "Language: " lang) " :results output" n r n "#+end_src"))
