...
(use-package
 json-ts-mode
 ; use json-ts-mode for .jsonl files
...
(use-package zmq
  :straight `(zmq :host github
                  ...
                  :files ("*" "src/*" ".dir-locals.el" "configure.ac" "Makefile.am" "gen-constants.awk")
                  :build (:not compile
                         "make CC=/opt/homebrew/bin/gcc-14 CXX=/opt/homebrew/bin/g++-14 CXXFLAGS=-std=c++17"))
  :demand t
  :config
  (require 'zmq))
#+end_src
