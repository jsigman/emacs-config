...
(use-package
 ...
 ;; if project.el has been loaded, then use it to set the project root, if projectile has been loaded, then use it to set the project root. If neither has been loaded, then raise an error.
